...
function install(app){
  ...
  originalPost.call(app,'/api/public/orders',async(req,res,next)=>{
    ...
    }catch(e){console.error('[public-all-order-route POST]',e);next(e);}
  });
}

// IMPORTANT: install before delegating to earlier listen wrappers.
