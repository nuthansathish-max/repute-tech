...
express.application.get=function(path,...handlers){
  ...
  // reads application settings. Preserve that getter behavior.
  ...
  // Compatibility route: the dashboard uses /businesses/:businessId/campaigns.
  ...
  // Public QR URL generated by the dashboard points to /qr/:slug; the canonical
  // customer hub implementation is /public/qr/:slug.
...
express.application.post=function(path,...handlers){
  ...
  // Stateless AI assistant endpoint used by the dashboard.
  ...
  // Dashboard-compatible Smart QR creation endpoint.
  ...
  // Dashboard-compatible menu creation endpoint. The UI calls the route with
  // "published" while the database model uses "isPublished".
  ...
  // Dashboard-compatible campaign creation endpoint.
  ...
  // Dashboard-compatible Google review sync route. The canonical server route
  // is /google/sync; this keeps the dashboard URL stable and uses the same logic.
