...
const required = ['server.js','index.html','schema.prisma','package.json','auth.js','ai.js','aiProvider.js','google.js','whatsapp.js','reviewPipeline.js','scheduler.js','customerJourney.js','seed.js'];
...
if (pkg.scripts?.start !== 'node server.js') throw new Error('Unexpected start script');
