...
await import('./subscription-trial-columns.js');
await import('./subscription-plan-sync.js');
...
await import('./menu-image-storage.js');
await import('./menu-item-edit-fix.js');
    ...
    handlers=handlers.map(handler=>async(req,res,next)=>{
      ...
      res.send=function(body){
        if(typeof body==='string'){
          ...
          if(body.includes('id="menu"') && !body.includes('menu-image-ui.js')){
