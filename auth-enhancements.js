...
function loadReviewActions(){
  if(document.querySelector('script[data-repute-review-actions]'))return;
  const s=document.createElement('script');
  s.src='/review-actions-v2.js?v=3';
  s.dataset.reputeReviewActions='1';
