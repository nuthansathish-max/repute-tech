...
function adminPage(){
  return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Admin Panel · reputetechs.in</title><style>'+
  ...
  '</style></head><body><header><div class="brand">reputetechs.in · Admin Panel</div><div><button class="light" onclick="location.href=\'/\'">Business Dashboard</button> <button class="light" onclick="location.reload()">Refresh</button></div></header><main>'+
